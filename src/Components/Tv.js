        ...
        <div className="dropdown-menu">
          ...
          <a className="dropdown-item" href="#">Link 3</a>
            ...
            <div className="row" style={{marginTop: "120px", marginLeft: "-764px", border: "1px solid grey", height: "300px", width: "350px"}}>
                ...
                <div className="col-sm-0">
                    <img src="https://images.samsung.com/is/image/samsung/pk-fhd-t5300-ua43t5300auxmm-frontblack-265965080?$PD_GALLERY_L_JPG$" width="200px"/>
                </div>
                <div className="col-sm-0 heart">
                    <img src={Heart} width="50px"/>
                </div>
                <div className="col-sm-8" style={{fontSize: "30px"}}><b>Rs. 45,000</b></div>
                <br />
                <br />
                <div className="row">
